...
left_img = cv2.resize(
    cv2.imread("./data/left/000000.png", cv2.IMREAD_GRAYSCALE),
    None,
    fx=0.5,
    fy=0.5,
...
right_img = cv2.resize(
    cv2.imread("./data/right/000000.png", cv2.IMREAD_GRAYSCALE),
    None,
    fx=0.5,
    fy=0.5,
    interpolation=cv2.INTER_LINEAR,
...
warnings.warn(
    "Visualizing disparity over sequence! This is optional and could take a lot of time (100 stereo pairs)!"
)

# maxi = 99
# for i in range(maxi):
#     l = cv2.resize(
#         cv2.imread("./data/left/{0:06d}.png".format(i), cv2.IMREAD_GRAYSCALE),
#         None,
#         fx=0.5,
#         fy=0.5,
#         interpolation=cv2.INTER_LINEAR,
#     )
#     r = cv2.resize(
#         cv2.imread("./data/right/{0:06d}.png".format(i), cv2.IMREAD_GRAYSCALE),
#         None,
#         fx=0.5,
#         fy=0.5,
#         interpolation=cv2.INTER_LINEAR,
...
T_C_F = np.asarray([[0, -1, 0], [0, 0, -1], [1, 0, 0]])
...
warnings.warn(
    "Visualizing pointcloud over sequence! This is optional and could take a lot of time (100 stereo pairs)!"
)
