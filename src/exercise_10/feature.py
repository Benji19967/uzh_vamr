...
class Feature(object):
    ...
    def check_motion(self, cam_states):
        ...
        last_cam_pose = Isometry3d(
            to_rotation(cam_states[last_id].orientation).T, cam_states[last_id].position
        )
        ...
        return (
            np.linalg.norm(orthogonal_translation)
    ...
    def initialize_position(self, cam_states):
        ...
        T_cam1_cam0 = Isometry3d(Feature.R_cam0_cam1, Feature.t_cam0_cam1).inverse()
        ...
        # Outer loop.
        while (
            outer_loop_count < self.optimization_config.outer_loop_max_iteration
            ...
            while (
                inner_loop_count < self.optimization_config.inner_loop_max_iteration
